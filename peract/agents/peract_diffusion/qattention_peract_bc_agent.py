...
from peract.voxel.augmentation import apply_se3_augmentation
from peract.voxel.voxel_grid import VoxelGrid
...
class QAttentionPerActBCAgent(Agent):
    ...
    def update(self, step: int, replay_sample: dict) -> dict:
        ...
        self._summaries = {
            ...
            "losses/collision_loss": (
                q_collision_loss.mean() if with_rot_and_grip else 0.0
            ),
        }
    ...
    def load_weights(self, savedir: str):
        ...
        for k, v in state_dict.items():
            ...
            if k in merged_state_dict:
                if "_voxelizer" in k and not self._training:
                    continue
